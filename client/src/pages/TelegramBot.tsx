...
export default function TelegramBot() {
  ...
  // تبسيط صلاحيات الوصول للبوت - جميع المستخدمين المسجلين يمكنهم الوصول
  const hasAdminAccess = currentUser !== null && currentUser !== undefined;

  console.log('🔍 صلاحيات الوصول للبوت:', {
