...
- **2025-08-10**: Implemented AI-powered item unification system using DeepSeek integration for intelligent duplicate detection and consolidation. System analyzes part numbers, descriptions, brands, and specifications to identify matching items with confidence scoring. Automated unification process safely merges related data (quotations, purchase orders) while maintaining referential integrity. Added comprehensive admin interface with duplicate analysis, batch processing capabilities, and detailed unification reporting.
